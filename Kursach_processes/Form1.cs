...
namespace Kursach_processes
{
    public partial class Form1 : Form
    {
        ...
        private void завершитиДеревоПроцесівToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                if (listView1.SelectedItems[0] != null)
        ...
        {
            string path = Interaction.InputBox("Введіть ім'я програми", "Запуск нової задачі");
